...
import com.wplatform.wizardcraft.engine.Session;
    ...
    public Session getSession() {
        return new Session() {
            ...
            public Account getAccount() {
                return getAttachment(LoginConstants.ACCOUNT_SESSION_KEY);
            }

            @Override
            public Character getCharacter() {
                return getAttachment(LoginConstants.CHARACTER_SESSION_KEY);
            }
        };
    }
