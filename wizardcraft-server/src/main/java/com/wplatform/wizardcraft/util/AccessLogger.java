...
public final class AccessLogger {
    ...
    public AccessLogger begin(NetworkConnection s) {
    ...
    public void log() {
        if (accessLogger.isInfoEnabled()) {
            try {
                ...
                logMsg.append("serial:").append(data.s.getSerialNumber()).append(" ")
                        .append(" seqId:").append(data.seqId).append(" ")
                        .append(" user:").append(""/*data.s.getUser()*/).append(" ")
                        .append(data.s.<String>getAttachment("remoteAddress"))
                        .append(" ").append(data.s.<String>getAttachment("localAddress")).append(" ").append("command:")
